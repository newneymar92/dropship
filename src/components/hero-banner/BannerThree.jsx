...
const BannerThree = () => {
  const handleClick = ()=>{
    window.open('products/42','winname','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=400,height=350');
  }
    return (
            ...
            <div className="row row--20">
              <div className="col-lg-9">
                <div className="slider-box-wrap">
                  <button onClick={handleClick} style={{backgroundColor:"red"}}>TEST</button>
                  <SlickSlider
